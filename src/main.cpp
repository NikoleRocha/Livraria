...
int main()
{
    ...
    std::cout << "Bem vindo a Livraria E-commerce! Os seguintes comandos te guiaram por nossa loja:" << std::endl;
    bool continuar = true;
    ...
    while (continuarUsuario)
    {
        ...
        case 1:
        {
            while (continuar)
            {
                ...
                std::cin >> dado;
                _comandoValido = comandoValido(dado);
